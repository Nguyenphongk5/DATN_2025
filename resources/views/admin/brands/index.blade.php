            ...
            <div class="bg-white shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="overflow-x-auto" >
                        <!-- Bộ lọc -->
                        <form action="{{ route('admin.brands.index') }}" method="GET" class="mb-6">
                            <div class="flex flex-wrap gap-4 items-center">
                                ...
                                <a href="{{ route('admin.brands.create') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded btn btn-primary">
                                    Thêm thương hiệu
                                </a>
                            </div>
                        </form>
                                ...
                                @foreach ($brands as $key => $brand)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @else
                                                <span class="text-red-600 font-semibold">Ngưng hoạt động</span>
                                            @endif
                                        </td>
