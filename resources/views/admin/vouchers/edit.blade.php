<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3 bg-gradient-to-r from-indigo-500 via-sky-500 to-cyan-400 rounded-2xl shadow-xl px-6 py-4 mb-6">
            ...
            <h2 class="font-extrabold text-2xl text-white tracking-wide drop-shadow-lg">Sửa voucher</h2>
        </div>
    </x-slot>
    <div class="py-8">
                ...
                <form action="{{ route('admin.vouchers.update', $voucher) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('code') border-red-400 @enderror" id="code" name="code" value="{{ old('code', $voucher->code) }}" placeholder="Nhập mã voucher">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('discount_value') border-red-400 @enderror" id="discount_value" name="discount_value" value="{{ old('discount_value', $voucher->discount_value) }}" placeholder="Nhập giá trị">
                        ...
                        <div>
                            ...
                            <input type="number" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('quantity') border-red-400 @enderror" id="quantity" name="quantity" value="{{ old('quantity', $voucher->quantity) }}" placeholder="Số lượng">
                        ...
                        <div>
                            ...
                            <input type="number" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('user_limit') border-red-400 @enderror" id="user_limit" name="user_limit" value="{{ old('user_limit', $voucher->user_limit) }}" placeholder="Mỗi người dùng tối đa">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('min_money') border-red-400 @enderror" id="min_money" name="min_money" value="{{ old('min_money', $voucher->min_money) }}" placeholder="Giá trị tối thiểu">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('max_money') border-red-400 @enderror" id="max_money" name="max_money" value="{{ old('max_money', $voucher->max_money) }}" placeholder="Giá trị tối đa">
                        ...
                        <div>
                            ...
                            <input type="date" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('start_date') border-red-400 @enderror" id="start_date" name="start_date" value="{{ old('start_date', $voucher->start_date) }}">
                        ...
                        <div>
                            ...
                            <input type="date" class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('end_date') border-red-400 @enderror" id="end_date" name="end_date" value="{{ old('end_date', $voucher->end_date) }}">
                        ...
                        <div>
                            ...
                            <select class="form-input w-full rounded-xl border-indigo-200 focus:ring-2 focus:ring-sky-400 @error('is_active') border-red-400 @enderror" id="is_active" name="is_active">
                                ...
                                <option value="0" {{ old('is_active', $voucher->is_active) == 0 ? 'selected' : '' }}>Tạm dừng</option>
                            </select>
