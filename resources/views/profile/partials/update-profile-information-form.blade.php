<form method="POST" action="{{ route('profile.update') }}" class="space-y-5">
    ...
    <div>
        ...
        <select name="province" id="province"
            class="block w-full border-gray-300 rounded-xl py-3 px-4 @error('province') border-red-500 @enderror">
    ...
    <div>
        ...
        <select name="district" id="district"
            class="block w-full border-gray-300 rounded-xl py-3 px-4 @error('district') border-red-500 @enderror">
    ...
    <div>
        ...
        <select name="ward" id="ward"
            class="block w-full border-gray-300 rounded-xl py-3 px-4 @error('ward') border-red-500 @enderror">
    ...
    <div>
        <button type="submit" class="bg-indigo-600 text-white py-3 px-6 rounded-xl hover:bg-indigo-700 transition">Cập
            nhật thông tin</button>
    </div>
</form>

{{-- Load JSON địa chỉ từ public --}}
<script>
