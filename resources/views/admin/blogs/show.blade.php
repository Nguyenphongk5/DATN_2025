<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <h2 class="font-extrabold text-2xl text-white tracking-wide drop-shadow-lg">Chi tiết bài viết</h2>
        </div>
    </x-slot>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex border-b pb-2">
                                ...
                                <span class="text-gray-900 font-semibold">{{ number_format($blog->price, 0, ',', '.') }}
                                    VNĐ</span>
                            </div>
                            ...
                            <div class="flex border-b pb-2">
                                ...
                                @if ($blog->price_sale)
                                <span class="text-red-600 font-semibold">{{ number_format($blog->price_sale, 0, ',',
                                    '.') }} VNĐ</span>
                                @else
