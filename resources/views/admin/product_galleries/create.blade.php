...
@section('title', 'Thêm ảnh sản phẩm - ' . $product->name)
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md">
            <div class="p-6">
                <form action="{{ route('admin.products.galleries.store', $product->id) }}" 
                      method="POST" 
                    ...
                    <div class="mb-6">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center" 
                            ...
                            <div id="uploadArea">
                                ...
                                <p class="text-sm text-gray-500">Hỗ trợ: JPG, PNG, GIF, WEBP (Tối đa 2MB mỗi ảnh)</p>
                                <input type="file" 
                                       name="images[]" 
                                       id="imageInput" 
                                       multiple 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        selectedFiles.forEach((file, index) => {
            ...
            const altText = document.querySelector(`input[name="alt_text[]"]:nth-of-type(${index + 1})`);
            if (altText) {
        ...
        .then(html => {
            ...
            if (html.includes('success')) {
                window.location.href = '{{ route("admin.products.galleries.index", $product->id) }}';
            } else {
                // Show errors
