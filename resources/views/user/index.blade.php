                            ...
                            <div class="container-fluid">
                                <div class="row justify-content-center text-center">
                                    <div class="col-md-10 pt-5">
                                        <h2 class="display-xl text-white ls-0 mt-5 pt-5 txt-fx slide-up">Sports Collection
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach ($products as $product)
                            <div class="col">
                                <div class="product-item">
                                    ...
                                    <figure>
                                        <a href="{{ route('detail', ['slug' => $product->slug]) }}" title="Product Title">
                                            <img src="images/product-thumb-1.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                                    <span class="text-ellipsis-2">{{ $product->name }}</span>
                                    <div class="d-flex justify-content-between">
                                        <p>
                                            <span class="text-dark">
                                                ₫{{ number_format($product->firstVariant->price_sale ?? $product->firstVariant->price, 0, ',', '.') }}
                                            </span>
                                            @if ($product->firstVariant->price_sale)
                                                <del>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    ...
                                    <figure>
                                        <a href="{{ route('home.create') }}" title="Product Title">
                                            <img src="images/product-thumb-2.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                                    <p>Leather Brown</p>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    ...
                                    <figure>
                                        <a href="{{ route('home.create') }}" title="Product Title">
                                            <img src="images/product-thumb-3.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    <figure>
                                        <a href="{{ route('home.create') }}" title="Product Title">
                                            <img src="images/product-thumb-4.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    <figure>
                                        <a href="{{ route('home.create') }}" title="Product Title">
                                            <img src="images/product-thumb-5.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                                    <p>Kids Shoes</p>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    <figure>
                                        <a href="{{ route('home.create') }}" title="Product Title">
                                            <img src="images/product-thumb-6.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                                    <p>Super Shoes</p>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    <figure>
                                        <a href="{{ route('home.create') }}" title="Product Title">
                                            <img src="images/product-thumb-7.png" alt="Product Thumbnail"
                                                class="img-fluid">
                                        </a>
                                    </figure>
                                    <p>Super Shoes</p>
