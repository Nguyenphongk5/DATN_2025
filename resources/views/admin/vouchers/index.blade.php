                    ...
                    <table class="w-full table-auto border-collapse shadow-xl rounded-2xl overflow-hidden">
                        <thead class="bg-gradient-to-r from-indigo-100 via-sky-100 to-cyan-100 text-indigo-700">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center text-base font-bold uppercase">Bắt đầu</th>
                                <th class="px-6 py-3 text-center text-base font-bold uppercase">Kết thúc</th>
                                ...
                                <tr class="hover:bg-gradient-to-r hover:from-indigo-50 hover:to-cyan-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($voucher->discount_type == 'percent')
                                            <span
                                                class="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400 text-white font-bold text-sm">Phần
                                                trăm</span>
                                        @else
                                            <span
                                                class="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-green-400 to-emerald-400 text-white font-bold text-sm">Cố
                                                định</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($voucher->is_active)
                                            <span
                                                class="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-green-400 to-cyan-400 text-white font-bold text-sm">Kích
                                                hoạt</span>
                                        @else
                                            <span
                                                class="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-gray-400 to-gray-600 text-white font-bold text-sm">Tạm
                                                dừng</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4">
