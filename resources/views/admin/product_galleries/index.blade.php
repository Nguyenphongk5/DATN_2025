<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <h2 class="font-extrabold text-2xl text-white tracking-wide drop-shadow-lg">Ảnh con sản phẩm</h2>
        </div>
    </x-slot>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"
                            ...
                            @foreach ($galleries as $gallery)
                                <div class="group relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200 hover:border-purple-300 transition-all duration-300 shadow-lg hover:shadow-xl"
                                    data-id="{{ $gallery->id }}">
                                    <!-- Drag Handle -->
                                    <div
                                        class="absolute top-3 left-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <div
                                            class="w-6 h-6 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center cursor-move shadow-lg">
                                    ...
                                    <div class="relative overflow-hidden rounded-xl bg-white shadow-inner">
                                        ...
                                        <!-- Overlay actions -->
                                        <div
                                            class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end justify-center pb-4">
                                            <div class="flex gap-2">
                                                ...
                                                <button
                                                    onclick="toggleActive({{ $product->id }}, {{ $gallery->id }})"
                                                    class="bg-white/90 backdrop-blur-sm text-gray-800 p-2 rounded-full hover:bg-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-110">
                                                    <i
                                        ...
                                        <!-- Sort order badge -->
                                        <div
                                            class="absolute top-3 right-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg">
                                            #{{ $gallery->sort_order }}
                                        </div>
                                        ...
                                        <div class="absolute bottom-3 left-3">
                                            ...
                                            @else
                                                <span
                                                    class="bg-gradient-to-r from-gray-500 to-gray-600 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg">
