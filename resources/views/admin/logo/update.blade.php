    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                <h1>Sửa logo</h1>
                <form action="{{ route('admin.logos.update', $logo->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        <label for="parent_id" class="form-label">Image</label>
                        <input type="file" class="form-control mb-3" id="name" name="image">
                        <img src="{{ asset('storage/' . $logo->image) }}" alt="" width="300">
                    </div>

                    <div class="mb-3">
                        <label for="is_active" class="form-label d-block">Trạng thái</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="active1" value="1"
                                {{ old('is_active', $logo->is_active) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="active0" value="0"
                                {{ old('is_active', $logo->is_active) == 0 ? 'checked' : '' }}>
                    ...
                    <a href="{{ route('admin.logos.index') }}" class="btn btn-outline-primary">Cancel</a>
                </form>
