<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <h2 class="font-extrabold text-2xl text-white tracking-wide drop-shadow-lg">Cập nhật ảnh con sản phẩm</h2>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('admin.products.galleries.update', [$product->id, $gallery->id]) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="alt_text" id="alt_text"
                                value="{{ old('alt_text', $gallery->alt_text) }}" placeholder="Mô tả ảnh để tối ưu SEO"
